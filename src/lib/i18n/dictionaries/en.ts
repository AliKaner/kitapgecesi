...
const en: Record<keyof typeof tr, string> = {
  ...
  "profil.tab.wishlist": "Reading List",
  "profil.tab.journal": "Journal",
  "profil.tab.badges": "Badges",
  "profil.library.all": "All",
  "profil.library.readSummary": "You've read {count} books",
  "profil.library.readingSummary": "You're reading {count} books",
  "profil.wishlist.empty": "No books on your reading list yet.",
  ...
  "showcase.widget.idCard": "About Me",
  "showcase.widget.quote": "Favorite Quote",
  "showcase.widget.review": "My Book Review",
  "showcase.widget.list": "My List",
  "showcase.widget.favoriteClub": "My Club",
  "showcase.widget.target": "My Reading Goal",
  "showcase.moveUp": "Move up",
  "showcase.moveDown": "Move down",
  "showcase.add": "Add Widget",
  ...
  "showcase.idCard.photo": "Photo",
  "showcase.idCard.name": "Name",
  "showcase.idCard.age": "Age",
  "showcase.idCard.height": "Height",
  "showcase.idCard.location": "Location",
  "showcase.idCard.about": "About",
  "showcase.idCard.header": "ID CARD",
  "showcase.quote.placeholder": "Write your favorite quote...",
  "showcase.quote.source": "Source (book / author)",
  "showcase.review.placeholder": "Your thoughts on this book...",
  "showcase.pickList": "Pick a list",
  "showcase.pickClub": "Pick a club",
  "showcase.empty": "This widget isn't configured yet.",
  "showcase.target.hint": "Your reading goal is set in Settings; shown here automatically.",
  ...
  "readingGoal.promptDesc": "Set a goal and track your progress all year.",
  "readingGoal.create": "Create goal",
  "readingGoal.modalTitle": "Your Reading Goal",
  "readingGoal.modalDesc": "How many books do you want to read this year?",
  "readingGoal.booksLabel": "Number of books",
  "readingGoal.save": "Save goal",
