const tr = {
  ...
  "profil.tab.wishlist": "Okuma Listesi",
  "profil.tab.journal": "Günlük",
  "profil.tab.badges": "Rozetler",
  "profil.library.all": "Tümü",
  "profil.library.readSummary": "{count} kitap okudun",
  "profil.library.readingSummary": "{count} kitap okuyorsun",
  "profil.wishlist.empty": "Henüz okumak istediğin kitap yok.",
  ...
  "showcase.widget.favorites": "En Sevdiğim Kitaplar",
  "showcase.widget.author": "Favori Yazar",
  "showcase.widget.idCard": "Benim Hakkımda",
  "showcase.widget.quote": "En Sevdiğim Alıntı",
  "showcase.widget.review": "Kitap İncelemem",
  "showcase.widget.list": "Listem",
  "showcase.widget.favoriteClub": "Kulübüm",
  "showcase.widget.target": "Okuma Hedefim",
  "showcase.moveUp": "Yukarı taşı",
  "showcase.moveDown": "Aşağı taşı",
  "showcase.add": "Bileşen Ekle",
  "showcase.remove": "Kaldır",
  ...
  "showcase.idCard.photo": "Fotoğraf",
  "showcase.idCard.name": "Ad",
  "showcase.idCard.age": "Yaş",
  "showcase.idCard.height": "Boy",
  "showcase.idCard.location": "Konum",
  "showcase.idCard.about": "Hakkımda",
  "showcase.idCard.header": "KİMLİK KARTI",
  "showcase.quote.placeholder": "Sevdiğin alıntıyı yaz...",
  "showcase.quote.source": "Kaynak (kitap / yazar)",
  "showcase.review.placeholder": "Bu kitap hakkındaki düşüncelerin...",
  "showcase.pickList": "Bir liste seç",
  "showcase.pickClub": "Bir kulüp seç",
  "showcase.empty": "Bu bileşen henüz yapılandırılmadı.",
  "showcase.target.hint": "Okuma hedefin Ayarlar'dan belirlenir; burada otomatik gösterilir.",
